...
function Vibe() {
  return (
    <div className='flex relative flex-col md:flex-row justify-center items-center w-full h-[100vh] md:h-[100vh] md:flex-row-reverse'>
      <div className="flex md:justify-start justify-center flex-1 md:items-center relative top-0 md:top-[-2] items-end w-full h-full"><img src={Vibee} alt="Wardrobe" className='md:w-120 w-60 object-contain' /></div>
      <div className='flex flex-col flex-1 justify-center md:items-end items-center text-left h-full md:pr-20 relative bottom-[14vh] md:bottom-0'>
