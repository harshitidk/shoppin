...
function Swipe() {
  return (
    <div className='flex relative flex-col md:flex-row justify-center items-center w-full h-[100vh] md:h-[100vh] bg-[#F5F2E8]'>
      <div className="flex md:justify-end justify-center flex-1 md:items-center relative top-5 md:top-0 items-end w-full h-full bottom-[2vh] md:bottom-0"><img src={Swipee} alt="Wardrobe" className='md:w-120 w-60 object-contain' /></div>
