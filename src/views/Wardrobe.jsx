...
function Wardrobe() {
  return (
    <div className='flex relative flex-col md:flex-row justify-center items-center w-full h-[100vh] md:h-[100vh] bg-[#F5F2E8]'>
      <div className="flex md:justify-end justify-center flex-1 md:items-center relative top-0 md:top-0 items-end w-full "><img src={Wardrobee} alt="Wardrobe" className='md:w-120 w-60 object-contain' /></div>
