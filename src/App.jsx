...
function App(){
  return(
    <div className='flex flex-col relative text-white overflow-x-hidden snap-y snap-mandatory overflow-y-scroll h-screen'>
    <div className='h-[10vh] fixed z-30 bg-white w-full flex justify-start items-center pl-5 md:pl-10'
    style={{ boxShadow: '0px 4px 33.1px 0px rgba(0,0,0,0.15)' }}><img src={shoppin} alt="shoppin" className='w-30 object-contain' /></div>
    <div 
